...
export const PT_BR_TRANSLATIONS = {
  ...
  'pages.experiences.detail.analytics': 'Analiticos da experiencia',
  'pages.experiences.detail.gallery': 'Galeria vinculada',
  'pages.experiences.detail.chart.jobs': 'Papeis',
  ...
  'pages.experiences.detail.chart.series': 'Conexoes',
  ...
  'pages.skills.detail.contextChart': 'Distribuicao por contexto',
