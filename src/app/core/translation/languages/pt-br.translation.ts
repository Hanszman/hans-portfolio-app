...
export const PT_BR_TRANSLATIONS = {
  ...
  'pages.admin.experiences.feedback.requiredStartDate': 'A data inicial é obrigatória.', 'pages.admin.experiences.feedback.invalidSortOrder': 'A ordem deve ser um número válido.',
