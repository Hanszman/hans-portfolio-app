...
export const EN_TRANSLATIONS = {
  ...
  'pages.skills.education.detail.date': 'Date',
  'pages.skills.education.detail.summary': 'Summary',
  'pages.skills.education.detail.gallery': 'Images',
  'pages.skills.languages.detail.proficiency': 'Proficiency',
  'pages.skills.languages.detail.code': 'Code',
  ...
  'pages.admin.imageAssets.fields.technologies.empty':
    'No public technology is available to relate right now.',
  'pages.admin.imageAssets.fields.formations.label': 'Related formations',
  'pages.admin.imageAssets.fields.formations.description': 'Select every formation linked to this image asset.',
  'pages.admin.imageAssets.fields.formations.empty': 'No formations are available.',
  'pages.admin.imageAssets.fields.spokenLanguages.label': 'Related spoken languages',
  'pages.admin.imageAssets.fields.spokenLanguages.description': 'Select every spoken language linked to this image asset.',
  'pages.admin.imageAssets.fields.spokenLanguages.empty': 'No spoken languages are available.',
  'pages.admin.imageAssets.fields.customers.label': 'Related customers',
  'pages.admin.imageAssets.fields.customers.description': 'Select every customer linked to this image asset.',
  ...
  'pages.admin.technologies.fields.projects.label': 'Related projects',
  'pages.admin.technologies.fields.projects.description': 'Select every project that uses this technology.',
  ...
  'pages.admin.technologies.fields.experiences.description': 'Select every experience that uses this technology.',
  'pages.admin.technologies.fields.experiences.empty': 'No experiences are available.',
  'pages.admin.technologies.fields.formations.label': 'Related formations',
  'pages.admin.technologies.fields.formations.description': 'Select every formation that uses this technology.',
  'pages.admin.technologies.fields.formations.empty': 'No formations are available.',
  ...
  'pages.admin.technologies.fields.links.description': 'Select every link connected to this technology.',
