...
export const EN_TRANSLATIONS = {
  ...
  'pages.admin.projects.fields.context.options.CLIENT': 'Client', 'pages.admin.projects.fields.context.options.PERSONAL': 'Personal', 'pages.admin.projects.fields.context.options.ACADEMIC': 'Academic', 'pages.admin.projects.fields.context.options.OPEN_SOURCE': 'Open source', 'pages.admin.projects.fields.context.options.OTHER': 'Other', 'pages.admin.projects.fields.status.options.COMPLETED': 'Completed', 'pages.admin.projects.fields.status.options.IN_PROGRESS': 'In progress', 'pages.admin.projects.fields.status.options.ARCHIVED': 'Archived', 'pages.admin.projects.fields.status.options.PLANNED': 'Planned', 'pages.admin.projects.fields.environment.options.WEB': 'Web', 'pages.admin.projects.fields.environment.options.MOBILE': 'Mobile', 'pages.admin.projects.fields.environment.options.DESKTOP': 'Desktop', 'pages.admin.projects.fields.environment.options.API': 'API', 'pages.admin.projects.fields.environment.options.OTHER': 'Other',
