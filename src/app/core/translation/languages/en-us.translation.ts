...
export const EN_TRANSLATIONS = {
  ...
  'common.formatting.toolbar': 'Text formatting',
  'common.formatting.bold': 'Bold',
  'common.formatting.italic': 'Italic',
  'common.formatting.underline': 'Underline',
  'common.formatting.unorderedList': 'Bulleted list',
  ...
  'taxonomy.skills.summary.types': 'Types',
  ...
  'taxonomy.skills.stack.testing': 'Testing',
  'taxonomy.skills.stack.devops': 'DevOps',
  'taxonomy.skills.stack.concepts': 'Concepts',
  ...
  'taxonomy.skills.type.markupAndFormatSyntaxes': 'Markup and Format Syntaxes',
  ...
  'taxonomy.skills.type.runtimeEnvironments': 'Runtime Environments',
  'taxonomy.skills.type.testingTools': 'Testing Tools',
  'taxonomy.skills.type.buildTools': 'Build Tools',
  'taxonomy.skills.type.documentationTools': 'Documentation Tools',
  'taxonomy.skills.type.preprocessors': 'Preprocessors',
  'taxonomy.skills.type.protocols': 'Protocols',
  'taxonomy.skills.type.artificialIntelligences': 'Artificial Intelligences',
  'taxonomy.skills.type.designPatterns': 'Design Patterns',
  'taxonomy.skills.type.programmingParadigms': 'Programming Paradigms',
  'taxonomy.skills.type.architectures': 'Architectures',
  'taxonomy.skills.type.principles': 'Principles',
  ...
  'pages.dashboard.stacks.title': 'Number of Technologies by Stack',
  'pages.dashboard.stacks.description':
    'See how the technology catalog is spread across each stack area, from Front-End to DevOps.',
  'pages.dashboard.distribution.label': 'Project footprint',
  'pages.dashboard.distribution.title': 'Number of Projects by Context',
  'pages.dashboard.distribution.description':
    'Compare how many published projects were built for professional, personal, academic and study contexts.',
  ...
  'pages.dashboard.technology.title': 'Number of Technologies by Level',
  'pages.dashboard.technology.description':
    'Breaks the technology catalog down by mastery level, from studying to advanced.',
  ...
  'pages.dashboard.technologyTypes.label': 'Technology types',
  'pages.dashboard.technologyTypes.title': 'Number of Technologies by Type',
  'pages.dashboard.technologyTypes.description':
    'Shows how the technology catalog is composed across families such as languages, frameworks, libraries and databases.',
  'pages.dashboard.technologyTypes.empty': 'No technology type breakdown was returned yet.',
  'pages.dashboard.projectsByType.label': 'Projects by technology type',
  'pages.dashboard.projectsByType.title': 'Number of Projects by Type of Technologies',
  'pages.dashboard.projectsByType.description':
    'Filter published projects by technology family to see how many rely on each type.',
  ...
  'pages.admin.technologies.feedback.requiredStack': 'The technology stack is required.',
  'pages.admin.technologies.feedback.requiredType': 'The technology type is required.',
  ...
  'pages.admin.projects.fields.status.options.ABANDONED': 'Abandoned',
  ...
  'pages.admin.projects.fields.environment.options.OTHER': 'Other',
