...
export const EN_TRANSLATIONS = {
  ...
  'pages.admin.operations.date': 'Date',
  ...
  'pages.admin.tags.fields.type.options.HIGHLIGHT': 'Highlight',
  ...
  'pages.admin.imageAssets.card.formations': 'Formations',
  'pages.admin.imageAssets.card.spokenLanguages': 'Spoken languages',
  'pages.admin.imageAssets.card.customers': 'Customers',
  ...
  'pages.admin.technologies.fields.name.label': 'Name',
  'pages.admin.technologies.fields.name.placeholder': 'Enter the technology name',
  'pages.admin.technologies.fields.category.label': 'Category',
  'pages.admin.technologies.fields.level.label': 'Level',
  'pages.admin.technologies.fields.frequency.label': 'Frequency',
  'pages.admin.technologies.fields.highlight.label': 'Highlight status',
  ...
  'pages.admin.technologies.card.frequency': 'Frequency',
  ...
  'pages.admin.technologies.card.projects': 'Projects',
  'pages.admin.technologies.card.experiences': 'Experiences',
  'pages.admin.technologies.card.formations': 'Formations',
  ...
  'pages.admin.technologies.options.LANGUAGE': 'Language',
  'pages.admin.technologies.options.FRAMEWORK': 'Framework',
  'pages.admin.technologies.options.LIBRARY': 'Library',
  'pages.admin.technologies.options.TOOL': 'Tool',
  'pages.admin.technologies.options.DATABASE': 'Database',
  ...
  'pages.admin.technologies.options.OTHER': 'Other',
  'pages.admin.technologies.options.BASIC': 'Basic',
  'pages.admin.technologies.options.INTERMEDIATE': 'Intermediate',
  'pages.admin.technologies.options.ADVANCED': 'Advanced',
  'pages.admin.technologies.options.FREQUENT': 'Frequent',
  'pages.admin.technologies.options.OCCASIONAL': 'Occasional',
  ...
  'pages.admin.technologyContexts.options.PROFESSIONAL': 'Professional',
  'pages.admin.technologyContexts.options.PERSONAL': 'Personal',
  'pages.admin.technologyContexts.options.ACADEMIC': 'Academic',
  'pages.admin.technologyContexts.options.STUDY': 'Study',
  'pages.admin.technologyContexts.card.technology': 'Technology',
  'pages.admin.technologyContexts.card.context': 'Context',
  'pages.admin.technologyContexts.card.startedAt': 'Start date',
  ...
  'pages.admin.experiences.feedback.requiredSlug': 'The slug is required.',
  'pages.admin.experiences.feedback.requiredCompanyName': 'The company name is required.',
  'pages.admin.experiences.feedback.requiredTitlePt': 'The Portuguese title is required.',
  ...
  'pages.admin.operations.localized.name': 'Name',
  'pages.admin.operations.localized.summary': 'Summary',
  'pages.admin.operations.localized.description': 'Description',
  ...
  'pages.admin.experiences.fields.titleEs.label': 'Spanish title',
  'pages.admin.experiences.fields.titleEs.placeholder': 'Enter the Spanish role title',
  'pages.admin.experiences.fields.summaryEs.label': 'Spanish summary',
  'pages.admin.experiences.fields.summaryEs.placeholder': 'Enter the Spanish summary',
  'pages.admin.experiences.fields.descriptionEs.label': 'Spanish description',
  'pages.admin.experiences.fields.descriptionEs.placeholder': 'Enter the Spanish description',
  'pages.admin.experiences.feedback.requiredTitleEs': 'The Spanish title is required.',
  'pages.admin.experiences.feedback.requiredSummaryEs': 'The Spanish summary is required.',
  ...
  'pages.admin.formations.fields.summaryEs.placeholder': 'Enter the Spanish summary',
  'pages.admin.formations.feedback.requiredTitleEs': 'The Spanish title is required.',
  'pages.admin.formations.feedback.requiredSummaryEs': 'The Spanish summary is required.',
  'pages.admin.spokenLanguages.fields.nameEs.label': 'Spanish name',
  'pages.admin.spokenLanguages.fields.nameEs.placeholder': 'Enter the language name in Spanish',
  'pages.admin.spokenLanguages.feedback.requiredNameEs': 'The Spanish name is required.',
  'pages.admin.customers.fields.summaryEs.label': 'Spanish summary',
  'pages.admin.customers.fields.summaryEs.placeholder': 'Enter the Spanish customer summary',
  'pages.admin.customers.feedback.requiredSummaryEs': 'The Spanish summary is required.',
  'pages.admin.jobs.fields.nameEs.label': 'Spanish name',
  'pages.admin.jobs.fields.nameEs.placeholder': 'Enter the job name in Spanish',
  'pages.admin.jobs.fields.summaryEs.label': 'Spanish summary',
  'pages.admin.jobs.fields.summaryEs.placeholder': 'Enter the job summary in Spanish',
  'pages.admin.jobs.feedback.requiredNameEs': 'The Spanish name is required.',
  'pages.admin.jobs.feedback.requiredSummaryEs': 'The Spanish summary is required.',
  ...
  'pages.admin.links.fields.descriptionEs.label': 'Spanish description',
  ...
  'pages.admin.tags.feedback.requiredNameEs': 'The Spanish name is required.',
