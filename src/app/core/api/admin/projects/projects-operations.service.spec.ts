...
import { ProjectsOperationsService } from './projects-operations.service';

describe('ProjectsOperationsService', () => {
  beforeEach(() =>
  ...
  it('loads public projects with paging and optional search', () => {
    const service = TestBed.inject(ProjectsOperationsService);
