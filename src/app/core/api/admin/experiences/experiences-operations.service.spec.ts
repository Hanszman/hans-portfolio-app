...
import { ExperiencesOperationsService } from './experiences-operations.service';

describe('ExperiencesOperationsService', () => {
  beforeEach(() =>
    TestBed.configureTestingModule({
      providers: [
        ExperiencesOperationsService,
  ...
  it('loads public experiences with paging and optional search', () => {
    const service = TestBed.inject(ExperiencesOperationsService);
